...
SELECT o.HISTORY_ID, ROUND(o.DURATION * o.DAILY_FEE * (1 - 0.01 * IFNULL(j.DISCOUNT_RATE, 0))) AS FEE
FROM (
    SELECT o.DURATION_TYPE, o.HISTORY_ID, o.CAR_ID, o.DURATION, j.CAR_TYPE, j.DAILY_FEE
    FROM (SELECT 
            CASE
                ...
                ELSE '7일 미만'
            END AS DURATION_TYPE, HISTORY_ID, CAR_ID, TIMESTAMPDIFF(day, START_DATE, END_DATE) + 1 DURATION
        FROM CAR_RENTAL_COMPANY_RENTAL_HISTORY
        ) o
        JOIN CAR_RENTAL_COMPANY_CAR j
        ON o.CAR_ID = j.CAR_ID
) o
LEFT JOIN CAR_RENTAL_COMPANY_DISCOUNT_PLAN j
ON o.CAR_TYPE = j.CAR_TYPE AND o.DURATION_TYPE = j.DURATION_TYPE
WHERE o.CAR_TYPE = '트럭'
